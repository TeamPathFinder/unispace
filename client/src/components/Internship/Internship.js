							...
							<div className="internship-filter-col flex fd-col">
								<div className="flex fd-col internship-filter-container">
									...
									>
										<CollapsibleArrow
											className={`filter-collapsible-arrow ${
												collapsibleHeaders['usa'] ? 'flip-vertical' : ''
											}`}
										/>
										<a> USA </a>
									</div>
									...
									>
										<CollapsibleArrow
											className={`filter-collapsible-arrow ${
												collapsibleHeaders['korea'] ? 'flip-vertical' : ''
											}`}
										/>
										<a> Korea </a>
									</div>
									...
									>
										<CollapsibleArrow
											className={`filter-collapsible-arrow ${
												collapsibleHeaders['remote'] ? 'flip-vertical' : ''
											}`}
										/>
										<a> Remote </a>
									</div>
									<div
										className={`filter-collapsible-div ${
											collapsibleHeaders['remote'] ? 'open' : ''
										}`}
									>
						...
						<>
							<div className="mobile-filter-container">
								...
								>
									...
									<CollapsibleArrow
										className={`filter-collapsible-arrow-mobile ${
											collapsibleHeaders['countries'] ? 'flip-vertical' : ''
										}`}
									/>
								</div>

								<div
									className={`mobile-filter-section fd-col ${
										collapsibleHeaders['countries'] ? '' : 'closed'
									}`}
								>
								...
								>
									...
									<CollapsibleArrow
										className={`filter-collapsible-arrow-mobile ${
											collapsibleHeaders['cities'] ? 'flip-vertical' : ''
										}`}
									/>
								</div>
								...
								<div
									className={`mobile-filter-section fd-col ${
										collapsibleHeaders['cities'] ? '' : 'closed'
									}`}
								>
