...
from internship.models import Job
...
for country in REGION:
    ...
    for city in REGION[country]:
        ...
        print("Total job listing:", len(jobs))
        ...
        for job in jobs:
            ...
            # GET APPLY LINK
            job_details = driver.find_element(by=By.CLASS_NAME, value="whazf.bD1FPe")
